...
export default class Strassen {
    ...
    /**
     * @constructor
     * Construye un objeto con todos los metodos de strassen
     */
    constructor() { }

    /**
     * Adicion de la matriz
     * @param {Matriz} a 
     * @param {Matriz} b
     * @return
     *  Objeto 
    ...
    /**
     * substracción de la matriz
     * @param {Matriz} a 
     * @param {Matriz} b
     * @return 
     *  un objeto tipo matriz
     */
    restar(a, b) {
        const c = new Matriz(a.columnas, a.filas, false);
        for (let i = 0; i < a.columnas; i++) {
     ...
     */
    matrixByCoef(matriz, coeficiente) {
        for (let i = 0; i < matriz.columnas; i++) {
            for (let j = 0; j < matriz.filas; j++) {
                matriz.matriz[i][j] *= coeficiente;
            }
        }
